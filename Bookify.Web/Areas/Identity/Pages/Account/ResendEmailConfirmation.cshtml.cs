...
namespace Bookify.Web.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var userNameInput = Input.UserName.ToUpper();
            var user = await _userManager.Users.SingleOrDefaultAsync(u => (u.NormalizedUserName == userNameInput || u.NormalizedEmail == userNameInput) && !u.IsDeleted);
            if (user == null)
            {
            ...
            {
                { "imageUrl" , "https://res.cloudinary.com/yassen-bookify/image/upload/v1761015504/icon-positive-vote-1_mroq3c.png" },
                { "header" , $"Hey {user.FullName} , Thanks for joining us!" },
                { "body" , "Please Confirm Your Emaill" },
